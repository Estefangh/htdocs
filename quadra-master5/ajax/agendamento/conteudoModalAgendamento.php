...
?>
      ...
      <?php if(!isset($_SESSION['usuarioID'])):?>
          ...
          <div class="mt-3" style="width:100% !important; display:flex;">
          
            <div id="acessaBtn " class="form-text "  style="font-weight:bold !important; color:black;flex:1; text-align:start; float:left;">Efetue login para agendar seu horário!</div>
            <button type="button" class="btn btn-secondary mr-3"style="" data-bs-dismiss="modal">Cancelar</button>
            </div>
