  ...
  if($seExisteQuadra > 0){
      foreach($consultaQuadras as $infoQuadras):
          ...
          $horario_inicial = $infoQuadras['horario_inicial'];
           $explodeIni = explode(':',$horario_inicial);
             $horaIniFinal = $explodeIni[0].':'.$explodeIni[1];
          $horario_final = $infoQuadras['horario_final'];
          $explodeFin = explode(':',$horario_final);
            $horaFinFinal = $explodeFin[0].':'.$explodeFin[1];
...
<div class="col aligncenter mt-4">
  ...
  <div class="d-flex">
    ...
    object-fit: cover;" >
      ...
      <div class="card-body">
          <p class="card-text"><span style="font-weight:bold">Horário de funcionamento </span></p>
          <p class="card-text"><span style="font-weight:300"><?=$horaIniFinal?> : <?=$horaFinFinal?></span></p>
