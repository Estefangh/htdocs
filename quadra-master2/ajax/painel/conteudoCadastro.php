...
<div class="row">
  ...
  <label for="inputEmail4" class="form-label">Senha:</label>
    <input type="text" class="form-control" id="senhaGinasio"value="">
    <div id="emailHelp" class="form-text">Deixe o campo em branco caso não queira editar</div>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col">
  <label for="inputEmail4" class="form-label">Senha:</label>
    <input type="text" class="form-control" id="senhaUser" value="">
    <div id="emailHelp" class="form-text">Deixe o campo em branco caso não queira editar</div>
  </div>
</div>
