...
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="text-align:end;">
      ...
      <div class="collapse navbar-collapse" style="margin-right:5em;" id="navbarSite">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
              <a class="nav-link" href="../../usuarios/view/cadastra.php">Cadastro</a>
          </li>
          ...
          <?php }else{?>
          <li class="nav-item">
              <a class="nav-link" href="cadastra.php">Possui um centro esportivo?</a>
          </li>
          <?php }else:?>
            <li class="nav-item">
              <a class="nav-link" href="cadastra.php">Possui um centro esportivo?</a>
